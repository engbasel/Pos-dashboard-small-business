                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      buildTextField('purchasePrice', 'purchasePrice',
                          isNumber: true, isRequired: true),
                      buildTextField('salePrice', 'salePrice', isNumber: true),
                      buildTextField('wholesalePrice', 'wholesalePrice',
                          isNumber: true),
                      buildTextField('taxRate', 'taxRate', isNumber: true),
                      buildTextField('quantity', 'quantity', isNumber: true),
                      buildTextField('alertQuantity', 'alertQuantity',
                          isNumber: true),
