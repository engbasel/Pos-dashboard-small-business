...
class _OrderListState extends State<OrderList> {
  ...
  Future<void> _addOrder() async {
    ...
    // await _syncWithFirebase(newOrder, 'add');
    _clearTextFields();
    _loadOrders();
  }
  ...
  Future<void> _removeOrder(int index) async {
    ...
    // await _syncWithFirebase(orderToDelete, 'delete');
    _loadOrders();
  }
  ...
  Future<void> _updateOrder(int index) async {
    ...
    // await _syncWithFirebase(updatedOrder, 'update');
    _clearTextFields();
    _loadOrders();
  }

  // Future<void> _syncWithFirebase(Order order, String action) async {
